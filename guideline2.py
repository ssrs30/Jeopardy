...
class Guidelines:
    def __init__(self, screen, filename):
        ...
        prev_path = current_dir / "Game Assets" / "prev.png"
        next_path = current_dir / "Game Assets" / "next_grey.png"
        ...
        self.prev_rect = self.prev.get_rect(topleft = (550, 600))
    ...
    def draw(self):
        ...
        self.screen.blit(self.next, (650, 600))
